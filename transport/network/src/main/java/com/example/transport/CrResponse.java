...
public final class CrResponse extends Table {
  ...
  public static CrResponse getRootAsCrResponse(ByteBuffer _bb) { return getRootAsCrResponse(_bb, new CrResponse()); }
  public static CrResponse getRootAsCrResponse(ByteBuffer _bb, CrResponse obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public CrResponse __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static void startCrResponse(FlatBufferBuilder builder) { builder.startTable(2); }
  ...
  public static final class Vector extends BaseVector {
    ...
    public CrResponse get(int j) { return get(new CrResponse(), j); }
    public CrResponse get(CrResponse obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
